...
var pm_file = 'HourlyLoansRollover.pm';
...
gulp.task('build', () => {
    run('mkdir dist ; cp -r Koha dist/. ; sed -i -e "s/{VERSION}/' + package_json.version + '/g" ' + pm_file_path_full_dist + ' ; cd dist ; zip -r ../' + release_filename + ' ./Koha ; cd .. ; rm -rf dist').exec();
